...
extern NSString * const kServiceFileUpdatedNotification;
...
extern NSString * const kAPIPathStartPlaying;
...
extern NSString * const kStreamingListExtensionKey;
extern NSString * const kStreamingListFileKey;
